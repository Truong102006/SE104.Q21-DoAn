  ...
  return (
    <div ref={containerRef} className="relative w-full">
      ...
      {isOpen && (
        <div
          className={cn(
            "absolute z-50 w-full mt-1.5 max-h-64 overflow-y-auto rounded-xl border border-border/80 bg-popover text-popover-foreground shadow-xl p-1",
            ...
            filteredOptions.map((option, idx) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "relative flex h-9 cursor-pointer select-none items-center rounded-lg px-3 pr-8 text-sm outline-none transition-colors font-medium gap-2",
